...
pumpe_on = 5                    # Duration of pump operation in milliseconds
pumpe_off = 2                   # Duration of pump off state in milliseconds
next_time = 0
...
while True:
    ...
    hum = sensor.humidity()
    if m < threshold_value and pumpe_is_on == 0 and temp >= 1 and hum <= 80:   #pumpe kører i X tid
        # Turn on the pump
        pumpe.value(1)
